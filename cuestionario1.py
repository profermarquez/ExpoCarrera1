...
if 'correo' not in st.session_state:
    st.session_state['correo'] = 'noreply@isfdyt.com'
...
p13 = st.text_input("Introduce tu dirección de correo electrónico:", key='correo', value='noreply@isfdyt.com', on_change=disable_enter_submit,disabled=False)
...
def enviar():
    ...
    # Resetear los valores de las preguntas
